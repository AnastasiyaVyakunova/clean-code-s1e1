...
var completedTasksHolder=document.getElementById("complete");//complete
...
var createNewTaskElement=function(taskString){
    ...
    label.className='li__label task';
...
var editTask=function(){
    ...
    //If class of the parent is .li_edit-mode
    if(containsClass){

        //switch to .li_edit-mode
    ...
    //toggle .li_edit-mode on the parent.
...
var taskCompleted=function(){
    ...
    //Append the task list item to the #complete
    var listItem=this.parentNode;
